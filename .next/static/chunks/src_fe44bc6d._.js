(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_fe44bc6d._.js", {
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyARla3AFX4jVpmjIvSvBmgjmUC8irgJt-Q"),
    authDomain: ("TURBOPACK compile-time value", "dukanper.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "dukanper"),
    storageBucket: ("TURBOPACK compile-time value", "dukanper.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "107691591978"),
    appId: ("TURBOPACK compile-time value", "1:107691591978:web:0d473e03c62bbea0c67653")
};
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const unsub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "AuthProvider.useEffect.unsub": async (firebaseUser)=>{
                    setUser(firebaseUser);
                    if (firebaseUser) {
                        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "users", firebaseUser.uid);
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[value]": ()=>({
                ...
                loading,
                userRole,
                async signup (name, email, password, role = "seller") {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__["updateProfile"])(cred.user, {
                        displayName: name
                    });
                    const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "users", cred.user.uid);
                    const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(userRef);
                ...
                async logout () {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__D__as__signOut$3e$__["signOut"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"]);
                }
            })
    }["AuthProvider.useMemo[value]"], [
        user,
...
_s(AuthProvider, "1SUaCnC8v1TiNEo7XFma8JFYKYY=");
_c = AuthProvider;
function useAuth() {
    _s1();
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WishlistProvider.useMemo[value]": ()=>({
                ...
                isWishlisted (productId) {
                    return items.some({
                        "WishlistProvider.useMemo[value]": (item)=>item.id === productId
                    }["WishlistProvider.useMemo[value]"]);
                },
                toggleWishlist (product) {
                    setItems({
                        "WishlistProvider.useMemo[value]": (prev)=>prev.some({
                                "WishlistProvider.useMemo[value]": (item)=>item.id === product.id
                            }["WishlistProvider.useMemo[value]"]) ? prev.filter({
                                "WishlistProvider.useMemo[value]": (item)=>item.id !== product.id
                            }["WishlistProvider.useMemo[value]"]) : [
                                ...prev,
...
_s(WishlistProvider, "tg7vXTSQunofXTgQ0bnX/d+5Tb0=");
_c = WishlistProvider;
...
//# sourceMappingURL=src_fe44bc6d._.js.map